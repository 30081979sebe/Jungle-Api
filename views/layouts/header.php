...
<nav class="glass-nav py-4 sticky top-0 z-10 text-white">
    <div class="container mx-auto flex justify-between items-center px-4">
        <a class="text-white text-2xl font-serif font-bold tracking-wider flex items-center">
        ...
        <button id="login-btn" class="glass-btn hover:scale-110 transform transition-all duration-300 p-2 rounded-full">
            <svg class="w-7 h-7 opacity-100" fill="#F4F6FF" viewBox="0 0 24 24">
